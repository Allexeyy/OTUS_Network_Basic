...
Вопрос: Какой идентификатор подсети в индивидуальном IPv6-адресе 2001:db8:acad::aaaa:1234/64?
    ...
    Ответ : Т.к. у нас маска сети 64 то берем первые 8 значений из адреса - 2001:0db8 (префикс)
    из которых 48 первых бит (6 значений) это префикс маршрутизации - 2001:0d
    и 16 бит (2 значения) это идентификатор подсети - b8

Ссылка на файл Cisco Packet Tracer
![](../Lab_04/lab_04.pkt)